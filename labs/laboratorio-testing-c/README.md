...
> R: El total que imrprime el programa no coincide con lo que calcule.
...
> R:carrito_init inicializa los valores de Carrito en 0 para poder usar y que no de valores basura.
...
> R:El nuevo test pasa correctamente.
...
> R:Este test falla. Esperaba el valor: 700 y obtuvo: 350
...
> R: La linea deberia multiplicar el precio del producto por la cantidad correspondiente.
...
> R: El test falla debido a que el 5to carrito_agregar devuelve 1.
...
> R: Si, las lineas 29 y 30 estan con #####. Se debe a que nunca se utilizaron.
...
> R: test unitario evalua una sola funcion aislado mientras que un test de integracion evalua varias funciones en conjunto. El bug de carrito_total lo detecto primero el test unitario.
...
> R: Es peligroso en C porque cuando se produce overflow no se detiene y puede sobreescribir en un espacio de memoria que ya tiene algo, en cambio con los otros lenguajes que corren dentro de otro entorno como un interprete y evalua la capcidad del arreglo.
...
> R: Crear los test tiene una mayor ventaja ya que por ejemplo al momento de querer cambiar alguna parte del codigo, no te preocupas de no saber si esta bien hecho, solo ejecutas los test y sabes. Tambien es fundamental evaluar los casos que podria dar error y como reacciona nuestro programa.
...
> R:El primer test no detecto el bug porque 350 ya es igual a 350*1, entonces coincidio con el resultado esperado.
